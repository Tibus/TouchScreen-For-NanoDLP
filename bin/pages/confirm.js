            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                this.addListener("click_b1", function (e) {
                  _this2.changePage(options.returnPage, { confirmType: options.confirmType, confirmResult: true });
                });

                this.addListener("click_b2", function (e) {
                  _this2.changePage(options.returnPage, { confirmType: options.confirmType, confirmResult: false });
                });
